...
contract Hero is ERC721, Ownable, AccessControl, IHero {
    ...
    constructor() public ERC721("Stickman Hero", "Hero") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    function _baseURI() internal view returns (string memory _newBaseURI) {
        return _url;
    }
